...
class XDChallenges2 extends StatelessWidget {
  XDChallenges2({
    Key key,
  }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Challenges 2')),
      drawer: MyDrawer(),
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(125.0, 14.0),
            child:
                // Adobe XD layer: 'Message Name' (component)
                SizedBox(
              width: 104.0,
              height: 19.0,
              child: XDMessageName(),
          ...
          Transform.translate(
            offset: Offset(19.0, 672.0),
            child: Container(
              width: 158.0,
              height: 63.0,
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(25.0),
                color: const Color(0xffff5136),
              ),
            ),
          ),
          Transform.translate(
            offset: Offset(199.0, 672.0),
            child: PageLink(
              links: [
                PageLinkInfo(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(25.0),
                  color: const Color(0xff58d432),
                ),
              ),
            ),
          ),
          Transform.translate(
            offset: Offset(235.0, 690.0),
            child: Text(
              'ACCEPT',
              style: TextStyle(
                fontFamily: 'Roboto',
                fontSize: 23,
                color: const Color(0xff242a17),
...
const String _svg_yt60s2 =
    '<svg viewBox="0.0 -0.3 375.7 812.3" ><defs><linearGradient id="gradient" x1="0.5" y1="-0.042471" x2="0.5" y2="1.0"><stop offset="0.0" stop-color="#00030e13" stop-opacity="0.0" /><stop offset="0.719543" stop-color="#6d040b0e" stop-opacity="0.43" /><stop offset="0.949794" stop-color="#f2060707" stop-opacity="0.95" /><stop offset="1.0" stop-color="#ff0a1417"  /></linearGradient></defs><path transform="translate(-931.0, 348.0)" d="M 931 464.0000305175781 L 931 355 L 1306.731323242188 355 L 1306.731323242188 464.0000305175781 L 931 464.0000305175781 Z" fill="url(#gradient)" stroke="none" stroke-width="0.25" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(-931.0, -355.33)" d="M 931 402.3251953125 L 931 355 L 1306.731323242188 355 L 1306.731323242188 402.3251953125 L 931 402.3251953125 Z" fill="#001331" stroke="#ffffff" stroke-width="0.25" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_ggqs3z =
    '<svg viewBox="0.0 10.5 375.7 801.5" ><path transform="matrix(0.0, -1.0, 1.0, 0.0, 25.5, 36.5)" d="M 12.99999904632568 0 L 26 19 L 0 19 Z" fill="none" stroke="#ffffff" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(-931.0, 409.67)" d="M 931 402.3251953125 L 931 355 L 1306.731323242188 355 L 1306.731323242188 402.3251953125 L 931 402.3251953125 Z" fill="#001331" stroke="#ffffff" stroke-width="0.25" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
