...
class XDChallenges3 extends StatelessWidget {
  XDChallenges3({
    Key key,
  }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Challenges 3')),
      drawer: MyDrawer(),
