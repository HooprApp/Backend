...
void main() => runApp(MaterialApp(home: MyApp(), routes: {
      ...
      'challenge1': (context) => XDChallenges1(),
      'challenge2': (context) => XDChallenges2(),
      'challenge3': (context) => XDChallenges3(),
      'challenge4': (context) => XDChallenges4(),
      'challenge41': (context) => XDChallenges41(),
      'challenge42': (context) => XDChallenges42(),
      'challengepop': (context) => XDChallengesPopup(),
      'challengepop1': (context) => XDChallengesPopup1(),
      'leader': (context) => XDLeaderboard(),
      'leaderpop': (context) => XDLeaderboardPopup(),
      'user1': (context) => XDUserProfile1(),
      'user2': (context) => XDUserProfile2(),
      'user3': (context) => XDUserProfile3(),
      'user4': (context) => XDUserProfile4(),
      'messages': (context) => XDMessageName(),
    }));
