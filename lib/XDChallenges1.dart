...
class XDChallenges1 extends StatelessWidget {
  XDChallenges1({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 351.0, 36.0),
                    size: Size(351.0, 36.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(20.0, 8.0, 62.0, 19.0),
                    size: Size(351.0, 36.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(303.5, 8.5, 23.0, 20.0),
                    size: Size(351.0, 36.0),
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
          ...
          Transform.translate(
            offset: Offset(12.0, 121.0),
            child:
                // Adobe XD layer: 'Challenge1' (group)
                PageLink(
              links: [
                PageLinkInfo(
                  transition: LinkTransition.Fade,
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(0.0, 0.0, 351.0, 126.0),
                      size: Size(351.0, 126.0),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
                      pinBottom: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(25.0, 25.0, 77.0, 76.0),
                      size: Size(351.0, 126.0),
                      pinLeft: true,
                      pinTop: true,
                      pinBottom: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(119.0, 37.0, 68.0, 19.0),
                      size: Size(351.0, 126.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(195.0, 37.0, 46.0, 19.0),
                      size: Size(351.0, 126.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(246.1, 38.5, 14.5, 14.5),
                      size: Size(351.0, 126.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child:
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(123.0, 67.0, 12.0, 12.0),
                      size: Size(351.0, 126.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Container(
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(141.0, 63.0, 139.0, 19.0),
                      size: Size(351.0, 126.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
          ...
          Transform.translate(
            ...
            child:
                // Adobe XD layer: 'Challenge2' (group)
                SizedBox(
              width: 351.0,
              height: 126.0,
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(195.0, 37.0, 37.0, 19.0),
                    size: Size(351.0, 126.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(141.0, 63.0, 161.0, 19.0),
                    size: Size(351.0, 126.0),
                    pinRight: true,
                    fixedWidth: true,
                    fixedHeight: true,
...
const String _svg_ufay50 =
    '<svg viewBox="315.5 46.5 23.0 20.0" ><path transform="translate(801.0, 1911.0)" d="M -473.4999084472656 -1853.499633789062 L -462.5001220703125 -1844.499633789062 L -473.4999084472656 -1853.499633789062 Z M -485.4996032714844 -1857.999633789062 C -485.4996032714844 -1861.589721679688 -482.5899047851562 -1864.500366210938 -478.9998168945312 -1864.500366210938 C -475.4096984863281 -1864.500366210938 -472.5 -1861.589721679688 -472.5 -1857.999633789062 C -472.5 -1854.410400390625 -475.4096984863281 -1851.499877929688 -478.9998168945312 -1851.499877929688 C -482.5899047851562 -1851.499877929688 -485.4996032714844 -1854.410400390625 -485.4996032714844 -1857.999633789062 Z" fill="#ffffff" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
...
const String _svg_uq2qgu =
    '<svg viewBox="16.7 20.1 1.0 1.0" ><path transform="translate(-325.93, -391.68)" d="M 342.6000061035156 411.7300109863281" fill="#000000" fill-opacity="0.0" stroke="#3d332a" stroke-width="16" stroke-miterlimit="10" stroke-linecap="butt" /></svg>';
const String _svg_qms1mu =
    '<svg viewBox="16.7 20.0 1.0 1.0" ><path transform="translate(-325.98, -391.44)" d="M 342.6600036621094 411.4800109863281" fill="#000000" fill-opacity="0.0" stroke="#3d332a" stroke-width="16" stroke-miterlimit="10" stroke-linecap="butt" /></svg>';
