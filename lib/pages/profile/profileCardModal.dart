...
class ProfileCardModal extends StatefulWidget {
  ProfileCardModal(this.challengeReceiverId, this.username, this.bp);
  ...
  @override
  _ProfileCardModalState createState() => _ProfileCardModalState();
}

class _ProfileCardModalState extends State<ProfileCardModal> {
