...
class XDChallenges41 extends StatelessWidget {
  XDChallenges41({
    Key key,
  }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Challenges 41')),
