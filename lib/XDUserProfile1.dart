...
class XDUserProfile1 extends StatelessWidget {
  XDUserProfile1({
    Key key,
  }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('User Profile 1')),
